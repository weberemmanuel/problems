...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for l in range(len(string.ascii_lowercase)):
            dict[string.ascii_lowercase[l]] = string.ascii_lowercase[(l+shift)%len(string.ascii_lowercase)]
        for l in range(len(string.ascii_uppercase)):
            dict[string.ascii_uppercase[l]] = string.ascii_uppercase[(l+shift)%len(string.ascii_uppercase)]
        return dict
    ...
    def decrypt_message(self):
        ...
        for shift in range(len(string.ascii_lowercase)):
            ...
            if num_word > max_words:
                ...
                message   = plainText
                max_shift = shift
        return (max_shift,message)

def decrypt_story():
    return CiphertextMessage(get_story_string()).decrypt_message()[1]
